...
export const roleAndPermissionData = [
    { label: "All Access", value: "complete_access" },
    { label: "Project(readonly)", value: "project-r" },
    { label: "Project(read + write)", value: "project-rw" },
    { label: "Task(readonly)", value: "task-r" },
    { label: "Task(read + write)", value: "task-rw" },
    { label: "TimeSheet(readonly)", value: "timeSheet-r" },
    { label: "TimeSheet(read + write)", value: "timeSheet-rw" },
    { label: "Leaders(readonly)", value: "leaders-r" },
    { label: "Leaders(read + write)", value: "leaders-rw" },
    { label: "Employees(readonly)", value: "employees-r" },
    { label: "Employees(read + write)", value: "employees-rw" },
    { label: "Clients(readonly)", value: "clients-r" },
    { label: "Clients(read + write)", value: "clients-rw" },
    { label: "ClientsProfile(readonly)", value: "clientsProfile-r" },
    { label: "ClientsProfile(read + write)", value: "clientsProfile-rw" },
    { label: "Members(readonly)", value: "members-r" },
    { label: "Members(read + write)", value: "members-rw" },
    { label: "MembersProfile(readonly)", value: "membersprofile-r" },
    { label: "MembersProfile(read + write )", value: "membersprofile-rw" },
    { label: "Holidays(readonly)", value: "holidays-r" },
    { label: "Holidays(read + write)", value: "holidays-rw" },
    { label: "Attendance(readonly)", value: "attendance-r" },
    { label: "Attendance(read + write)", value: "attendance-rw" },
    { label: "EmployeeAttendance(readonly)", value: "employeeattendance-r" },
    { label: "EmployeeAttendance(read + write)", value: "employeeattendance-rw" },
    { label: "LeaveRequest(readonly)", value: "leaverequest-r" },
    { label: "LeaveRequest(read + write)", value: "leaverequest-rw" },
    { label: "Department(readonly)", value: "department-r" },
    { label: "Department(read + write)", value: "department-rw" },
    { label: "Invoices(readonly)", value: "invoices-r" },
    { label: "Invoices(read + write)", value: "invoices-rw" },
    { label: "Payments(readonly)", value: "payments-r" },
    { label: "Payments(read + write)", value: "payments-rw" },
    { label: "Expenses(readonly)", value: "expenses-r" },
    { label: "Expenses(read + write)", value: "expenses-rw" },
    { label: "EmployeeSalary(readonly)", value: "employeesalary-r" },
    { label: "EmployeeSalary(read + write)", value: "employeesalary-rw" },
    { label: "TicketView(readonly)", value: "ticketview-r" },
    { label: "TicketView(read + write)", value: "ticketview-rw" },
    { label: "TicketDetails", value: "ticketdetails-r" },
    { label: "TicketDetails", value: "ticketdetails-rw" },



];

export const valueToLabelRole = {
    "complete_access": "All Access",
    "project-r": "Project(readonly)",
    "project-rw": "Project(read + write)",
    "task-r": "Task(readonly)",
    "task-rw": "Task(read + write)",
    "timeSheet-r": "TimeSheet(readonly)",
    "timeSheet-rw": "TimeSheet(read + write)",
    "leaders-r": "Leaders(readonly)",
    "leaders-rw": "Leaders(read + write)",
    "employees-r": "Employees(readonly)",
    "employees-rw": "Employees(read + write)",
    "clients-r": "Clients(readonly)",
    "clients-rw": "Clients(read + write)",
    "clientsProfile-r": "ClientsProfile(readonly)",
    "clientsProfile-rw": "ClientsProfile(read + write)",
    "members-r": "Members(readonly)",
    "members-rw": "Members(read + write)",
    "membersprofile-r": "MembersProfile(readonly)",
    "membersprofile-rw": "MembersProfile(read + write )",
    "holidays-r": "Holidays(readonly)",
    "holidays-rw": "Holidays(read + write)",
    "attendance-r": "Attendance(readonly)",
    "attendance-rw": "Attendance(read + write)",
    "employeeattendance-r": "EmployeeAttendance(readonly)",
    "employeeattendance-rw": "EmployeeAttendance(read + write)",
    "leaverequest-r": "LeaveRequest(readonly)",
    "leaverequest-rw": "LeaveRequest(read + write)",
    "department-r": "Department(readonly)",
    "department-rw": "Department(read + write)",
    "invoices-r": "Invoices(readonly)",
    "invoices-rw": "Invoices(read + write)",
    "payments-r": "Payments(readonly)",
    "payments-rw": "Payments(read + write)",
    "expenses-r": "Expenses(readonly)",
    "expenses-rw": "Expenses(read + write)",
    "employeesalary-r": "EmployeeSalary(readonly)",
    "employeesalary-rw": "EmployeeSalary(read + write)",
    "ticketview-r": "TicketView(readonly)",
    "ticketview-rw": "TicketView(read + write)",
