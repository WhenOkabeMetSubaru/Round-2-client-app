                    ...
                    <div className="h-right d-flex align-items-center order-1">
                        ...
                        <Dropdown className="dropdown user-profile ms-2 ms-sm-3 d-flex align-items-center">
                            <div className="u-info me-2">
                                <p className="mb-0 text-end line-height-sm "><span className="font-weight-bold">{(currentUser?.first_name + currentUser?.last_name) || "User Name"}</span></p>
                            ...
                            <Dropdown.Menu className="rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                <div className="card border-0 w280">
                                    <div className="card-body pb-0">
                                        <div className="d-flex py-1">
                                            ...
                                            <div className="flex-fill ms-3">
                                                <p className="mb-0"><span className="font-weight-bold">{ currentUser?.first_name + currentUser?.last_name }</span></p>
                                                <small className="">{currentUser?.email}</small>
                                            </div>
                                        </div>
                                    ...
                                    <div className="list-group m-2 ">
                                        ...
                                        <div onClick={()=>{auth?.clearJWT(()=>{}); history.push("/sign-in")}} to="sign-in" className="list-group-item list-group-item-action border-0 "><i className="icofont-logout fs-6 me-3"></i>Signout</div>
                                        <div><hr className="dropdown-divider border-dark" /></div>
